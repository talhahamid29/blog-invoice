    ...
    return (
        <div className="mx-auto max-w-2xl px-6 py-10 sm:px-12 sm:py-16 lg:max-w-7xl ">
            <div className=" grid grid-cols-1 lg:grid-cols-3 gap-y-10 sm:gap-x-4">
                ...
                <div >
                    <h3 className="text-gray-500 uppercase font-medium pb-2">awards & honors</h3>
                ...
                <div >
                    <p className="text-gray-600  text-base font-normal leading-6 pe-24">
                        When our team provides design and digital marketing. Applied arts can include <b>industrial design, graphic design, fashion design,</b> and the decorative arts which traditionally includes craft objects.
                    </p>
                </div>
